...
License Boundary uses layered licensing beginning with version `0.1.0-rc1`.
...
These project licenses govern this repository and the distributed Skill
package. They do not determine the license of repositories analyzed or edited
with the Skill; those repositories remain governed by their own rights and the
terms selected for them.
...
- root `NOTICE.md`, `AGENTS.md`, `.github/`, `.gitignore`, `scripts/`, and
  `VERSION`; and
- any other original functional file not explicitly assigned another license
  in this document.

SUL-1.0 permits personal, noncommercial, and internal business use. It permits
free redistribution or provision to others only for noncommercial purposes.
...
The Creative Commons license does not apply to functional Skill instructions,
agent metadata, notices, governing license texts, or other materials assigned
SUL-1.0 above.

## Third-party material and governing texts

No project-level license changes the copyright, license, or attribution of
third-party material. Links and short factual descriptions of licenses or
external projects do not incorporate or relicense those projects' contents.

Where a file contains third-party material under a compatible or separate
license, that material remains under its original terms. The complete
Sustainable Use License text in `LICENSE`, its byte-identical distributed copy
at `skills/license-boundary/LICENSE.txt`, and the linked Creative Commons legal
